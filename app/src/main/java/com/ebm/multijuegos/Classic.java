...
public class Classic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //juegi 1
        //primero busca la URL
        c1loader = "https://www.google.com/logos/2010/pacman10-i.html";
                //se declara la variable y se manda llamar la imagen de xml
        c1 = (RelativeLayout) findViewById(R.id.c_item1);
        //se crea la accion a la imagen cada vez que se pulse
        ...
        c4 = (RelativeLayout)findViewById(R.id.c_item3);
